...
export default function DoghouseHideoutPostPage() {
  ...
  const additionalImages: Array<{ src: string; alt: string }> = [
    // Example: { src: "/images/blog/doghouse-angle1.webp", alt: "Doghouse view 1" },
    // Example: { src: "/images/blog/doghouse-angle2.webp", alt: "Doghouse view 2" },
  ];
      ...
      <article>
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="prose dark:prose-invert max-w-none md:col-span-1 order-2 md:order-1">
            ...
            <ul>
              <li><strong>Estimated build time:</strong> ≈7–10 mins</li>
              <li><strong>Mats needed:</strong> ≈27 pcs</li>
